<?php
    ...
    $sql = 'SELECT * FROM Orders WHERE Location = "' . $location . '"';
    ...
    if($result->num_rows > 0){
        while($row = $result->fetch_assoc()){
            ...
            $sql2 = 'SELECT Orders.OrderID, Orders.PickUpTime, Orders.OrderStatus, Dish.Name, DishInOrder.Quantity FROM (Orders NATURAL JOIN DishInOrder NATURAL JOIN Dish) WHERE Orders.OrderID=' . $tempOrderID . ' ORDER BY Orders.OrderID';
            //(Orders.Location = ' . $location . ' AND
